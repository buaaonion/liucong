...
public final class MachineC {
	...
	public MachineC(String fileName) {
	...
	public boolean toFile() {
		this.hFile.append("\n\n#endif\n");
		File cFile = new File(BStar.baseRoot + "/c/" + fileName + ".c");
		File hFile = new File(BStar.baseRoot + "/c/" + fileName + ".h");
